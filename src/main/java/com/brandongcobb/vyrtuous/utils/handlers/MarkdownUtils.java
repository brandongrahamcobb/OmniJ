/*  MarkdownUtils.java The purpose of this class is to access the data
 *  stored in an MarkdownContainer object.
 *
...
public class MarkdownUtils {
    ...
    public MarkdownUtils(MetadataContainer container) {
