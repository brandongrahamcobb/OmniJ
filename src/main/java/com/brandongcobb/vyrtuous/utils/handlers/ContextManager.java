...
public class ContextManager {
    ...
    public void printNewEntries(boolean includeUserMessages, boolean includeAIResponses, boolean includeToolCalls, boolean includeToolOutputs, boolean includeTokens, boolean includeSystemNotes, boolean includeProgressiveSummary, boolean includeShellOutput) {
