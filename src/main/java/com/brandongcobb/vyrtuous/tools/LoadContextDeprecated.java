...
public class LoadContextDeprecated implements CustomTool<LoadContextInput, ToolStatus> {

    private final ContextManager modelContextManager;
    private final ContextManager userContextManager;
    private static final ObjectMapper mapper = new ObjectMapper();
    
    public LoadContextDeprecated(ContextManager modelContextManager, ContextManager userContextManager) {
