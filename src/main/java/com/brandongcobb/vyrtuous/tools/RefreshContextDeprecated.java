...
public class RefreshContextDeprecated implements CustomTool<RefreshContextInput, ToolStatus> {
    
    private static final ObjectMapper mapper = new ObjectMapper();
    private final ContextManager modelContextManager;
    private final ContextManager userContextManager;

    public RefreshContextDeprecated(ContextManager modelContextManager, ContextManager userContextManager) {
