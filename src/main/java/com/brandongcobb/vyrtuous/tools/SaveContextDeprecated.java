...
public class SaveContextDeprecated implements CustomTool<SaveContextInput, ToolStatus> {

    private final ContextManager modelContextManager;
    private final ContextManager userContextManager;
    private static final ObjectMapper mapper = new ObjectMapper();
    
    public SaveContextDeprecated(ContextManager modelContextManager, ContextManager userContextManager) {
