...
Send a json_chat object with needsClarification as true if you need clarification. Only make localShellCommandSequenceFinished true when the token count becomes close to the context limit. Summarize the context in the last messageText so the crude context can be wiped, maintaining the original directive and continuing off of the summary in the revised context. needsClarification should be false if localShellCommandSequenceFinished is true.
    {
      "responseId": "resp_1234567890",
